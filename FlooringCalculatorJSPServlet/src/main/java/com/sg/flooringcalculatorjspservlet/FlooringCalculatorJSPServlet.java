...
public class FlooringCalculatorJSPServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String floorWidth = request.getParameter("floorWidth");
        String floorLength = request.getParameter("floorLength");
        
        double width = Double.parseDouble(floorWidth);
        double length = Double.parseDouble(floorLength);
        
        double totalArea = width*length;
        double totalMaterialCost = totalArea*58.26;
        double totalTime = totalArea/20;
        double totalLaborCost = totalTime*86;
        double totalCost = totalLaborCost+totalMaterialCost;
